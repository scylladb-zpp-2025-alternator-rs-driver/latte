...
#[cfg(feature = "cql")]
use crate::scripting::cql::consistency::{Consistency, SerialConsistency};

#[cfg(feature = "alternator")]
use crate::scripting::alternator::consistency::Consistency;
...
#[cfg(feature = "alternator")]
const DEFAULT_CONSISTENCY: &str = "EVENTUAL";
...
pub struct ConnectionConf {
    ...
    #[clap(long("consistency"), required = false, default_value = DEFAULT_CONSISTENCY)]
